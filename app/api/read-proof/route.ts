...
export async function POST(request: Request) {
  ...
  const content: Array<Record<string, string>> = [{
    ...
    text: [
      ...
      "Write like a sharp founder/operator. Short, concrete, plain English.",
      ...
      JSON.stringify({
        ...
        publicClaim: "one safe public claim, no guarantee language",
        proofMeaning: "what this proves about content, trust, demand, sales calls or authority",
        headlineOptions: ["3-8 word image headline", "3-8 word image headline"],
